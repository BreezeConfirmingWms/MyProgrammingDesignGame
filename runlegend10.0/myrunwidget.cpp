...
void gamewidget::paintEvent(QPaintEvent *)
{
    ...
    else//游戏中绘制
    {
        ...
        painter.drawText(100,100,QString("Coinnum:%1%").arg(Coinnum));//金币数量绘制
        painter.drawText(500,100,QString("Score:%1%").arg(r->getscore()));//分数绘制
